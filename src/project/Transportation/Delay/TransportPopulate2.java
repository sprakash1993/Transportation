...
public class TransportPopulate2 extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
        ...
        HBaseAdmin newAdmin = new HBaseAdmin(conf);
        ...
        newhtd.setValue("prefix_split_key_policy.prefix_length", "4");
        
        newAdmin.disableTable(tableName);
        newAdmin.modifyTable(Bytes.toBytes(tableName), newhtd);
        newAdmin.enableTable(tableName);

        conf.set("hbase.zookeeper.quorum", args[2]);

        int exitCode = ToolRunner.run(conf, new TransportPopulate2(), args);
	...
	public int run(String[] arg0) throws Exception {
        ...
        job.setJarByClass(TransportPopulate2.class);
