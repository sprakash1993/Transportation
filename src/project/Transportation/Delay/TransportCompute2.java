...
public class TransportCompute2 extends Configured implements Tool {
    ...
    public static class TransportMapper extends TableMapper<IntPair, Text> {
        ...
        public void map(ImmutableBytesWritable key, Result value,
            ...
            System.out.println(parsedYear+" "+parsedQuarter);
            for (int i = 0; i < busiestAirports.size(); i++) {
                ...
                if (parsedYear == Integer.parseInt(busiestRecord[0])) {
                    for (int y = 1; y < busiestRecordsize; y++) {
                    	System.out.println(destinationCity+" "+busiestRecord[y].substring(3));
    ...
    public static void main(String[] args) throws Exception {
        ...
        int exitCode = ToolRunner.run(conf, new TransportCompute2(), args);
    ...
    public int run(String[] arg0) throws IOException {
        ...
        job.setJarByClass(TransportCompute2.class);
